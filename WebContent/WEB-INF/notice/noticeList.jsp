	...
	<div class="container-fluid">
		<div class="row">
			<ul class="pagination">
				...
				<li><a href="./noticeList.do?curPage=<%=pager.getStartNum() - 1%>"><span
				...
				<li><a href="./noticeList.do?curPage=<%=pager.getLastNum() + 1%>"><span
						class="glyphicon glyphicon-chevron-right"></span></a></li>
				<%}%>
				<li><a href="./noticeList.do?curPage=<%=pager.getTotalPage()%>"><span
